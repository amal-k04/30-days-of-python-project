...
Date:25-11-2024
Description:Python program calculates the area of a triangle and determines its type: Isosceles, Equilateral, or Scalene (different sides).
'''
...
area=math.sqrt(s*(s-side_1)*(s-side_2)*(s-side_3))#Heron's formula
